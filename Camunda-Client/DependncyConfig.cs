...
public static class DependncyConfig
{
	public static void AddCamunda(this IServiceCollection services)
	{
		...
		camundaBuilder.AddWorker<TaskAWorker>(TaskAWorker.Topics);
		camundaBuilder.AddWorker<TaskBWorker>(TaskBWorker.Topics);
		camundaBuilder.AddWorker<TaskCWorker>(TaskCWorker.Topics);
